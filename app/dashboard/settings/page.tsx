...
import { Settings, Bell, Shield, Globe, Palette, Mail, Lock } from 'lucide-react'
          ...
          <div className="relative w-full bg-white dark:bg-[#23233a] rounded-xl p-8 md:p-12 flex flex-col items-center justify-center gap-6 shadow-2xl">
            ...
            <div className="relative z-10 flex flex-col items-center gap-4">
              <div className="w-20 h-20 bg-[#3366ff]/20 rounded-full flex items-center justify-center">
                <Settings className="w-10 h-10 text-[#3366ff]" />
              </div>
              <div className="text-center">
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Settings Coming Soon</h2>
                <p className="text-slate-500 dark:text-slate-400 max-w-md">
                  We're building comprehensive settings to help you customize your experience, 
                  manage notifications, and configure your account preferences.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 w-full max-w-2xl">
                <div className="bg-slate-50 dark:bg-[#1a1a2e]/80 rounded-lg p-4 border border-slate-200 dark:border-white/10">
                  <Bell className="w-6 h-6 text-[#3366ff] mb-2" />
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1">Notifications</h3>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Manage email and push notification preferences</p>
                </div>
                <div className="bg-slate-50 dark:bg-[#1a1a2e]/80 rounded-lg p-4 border border-slate-200 dark:border-white/10">
                  <Palette className="w-6 h-6 text-[#3366ff] mb-2" />
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1">Appearance</h3>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Customize theme, language, and display options</p>
                </div>
                <div className="bg-slate-50 dark:bg-[#1a1a2e]/80 rounded-lg p-4 border border-slate-200 dark:border-white/10">
                  <Shield className="w-6 h-6 text-[#3366ff] mb-2" />
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1">Privacy & Security</h3>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Control privacy settings and security options</p>
                </div>
              </div>
            </div>
          </div>
